...
public ref struct RCAS_UDPMessage
{
    ...
    {
        string message = (char)0 + "§" + ip_address + "§" + tcp_port + "§" + udp_port;
    ...
    {
        string str = Encoding.ASCII.GetString(msg.raw_data);
        string[] strs = str.Split("§");
        return (strs[1], int.Parse(strs[2]), int.Parse(strs[3]), strs[4]);
    }
